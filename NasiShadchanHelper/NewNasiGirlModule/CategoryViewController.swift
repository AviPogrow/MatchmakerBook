...
class CategoryViewController: UICollectionViewController {
    ...
    func buildSections() -> [[GirlGroup]] {
        ...
        let fTWNeedsKovea = GirlGroup(imageString: "kush", titleString: "FTW - Needs Kovea Ittim", arrayOfNasiGirls: arrNeedsKoveaIttim)
        
        let fTWDoesNotNeedKovea = GirlGroup(imageString: "Brissman", titleString: "FTW - Doesn't Need Kovea", arrayOfNasiGirls: arrDoesNotNeedKovea)
...
//                item.contentInsets.bottom = 16
    ...
    let FTWOptions = ["Needs Kovea Ittim","Doesn't Need Kovea"]
