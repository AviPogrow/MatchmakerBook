...
class GirlCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        let stackView = UIStackView(arrangedSubviews: [appIconImageView, VerticalStackView(arrangedSubviews: [nameLabel, cityLabel,seminaryLabel], spacing: 4), getButton])
