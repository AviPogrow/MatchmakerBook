...
class ResumeViewController: UITableViewController {
    ...
    lazy var  subject = selectedNasiGirl.nameSheIsCalledOrKnownBy + " " + selectedNasiGirl.lastNameOfGirl + " - Shidduch Information" +
...
extension ResumeViewController: URLSessionDownloadDelegate {
    ...
    func downloadProfileImage() {
        ...
        print("the imageurl is\(profileImageURL)")
    ...
    func urlSession(_ session: URLSession, downloadTask: URLSessionDownloadTask,
     ...
     print("the localurl is\(localURL) and\(localImageURL)")
