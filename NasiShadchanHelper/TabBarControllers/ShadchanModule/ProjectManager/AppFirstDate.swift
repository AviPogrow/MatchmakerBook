...
class AppFirstDate: NSObject {
    ...
    /*
    func createFirstDate() {
        let firstDate = AppFirstDate(boyID: "", girlID: "", dateCreated: "", boyFirstName: "", boyLastName: "", girlFirstName: "", girlLastName: "", girlImageDownloadString: "", girlResumeDownlaodString: "", boySendResumeEmail: "", boySendResumeText: "", boyCell: "", boyPhotoImageURL: "")
        
        let dict = firstDate.toAnyObject()
