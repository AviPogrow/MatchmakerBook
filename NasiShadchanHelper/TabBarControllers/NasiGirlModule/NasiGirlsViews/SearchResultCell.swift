...
class SearchResultCell: UICollectionViewCell {
    ...
    var shadchanGirl: ShadchanGirl! {
        didSet {
          //  let heightString = "\(shadchanGirl.heightInFeet)" + "\'" + " " + "\(shadchanGirl.heightInInches)"  + "\""
         //   nameLabel.text = shadchanGirl!.lastNameOfGirl + " " + shadchanGirl!.firstNameOfGirl + " - "
         //   + heightString
            
            //cityLabel.text =  "\(girl!.age)" + " yrs - " + shadchanGirl!.cityOfResidence
            //ageLabel.text = "\(girl!.age)"
            //seminaryLabel.text = "\(shadchanGirl!.seminaryName)"
            //planLabel.text = "\(shadchanGirl!.plan)"
           // planLabel.textColor = .lightGray
            
           // guard let resumeImageUrl = shadchanGirl?.documentDownloadURLString else { return }
           // guard let profileImageUrl = shadchanGirl?.imageDownloadURLString else {return }
